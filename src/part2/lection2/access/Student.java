...
public class Student {
	...
	public Student(){
			System.out.println("Конструктор Студента ua.com.glybovets.lection5.access");
	}
	
	//А от цей метод має специфікатор доступу за замовчанням і саме тому не може бути
